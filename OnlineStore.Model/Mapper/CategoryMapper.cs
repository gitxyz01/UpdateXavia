...
namespace OnlineStore.Model.Mapper
{
    public static class CategoryMapper
    {
        ...
        public static IEnumerable<DetailCategoryViewModel> ConvertToListDetailCategoryViewModelAminTy(this IEnumerable<ecom_Categories> categories)
        {
            foreach (ecom_Categories category in categories)
            {
                yield return category.ConvertToDetailCategoryViewModelAdminTy();
            }
        }
