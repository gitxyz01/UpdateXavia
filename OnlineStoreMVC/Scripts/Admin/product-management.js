...
ProductManagement = {
    ...
    changeMode: function (imageId,mode) {
        switch (mode) {
            case Mode.Edit: {
                $("#EditProduct_ListProductImages tr.display-mode[data-id='" + imageId + "']").removeClass("d-none").addClass("d-none");
                $("#EditProduct_ListProductImages tr.edit-mode[data-id='" + imageId + "']").removeClass("d-none");
                break;
            }
            case Mode.Display: {
                $("#EditProduct_ListProductImages tr.display-mode[data-id='" + imageId + "']").removeClass("d-none");
                $("#EditProduct_ListProductImages tr.edit-mode[data-id='" + imageId + "']").removeClass("d-none").addClass("d-none");
                break;
            }
        }
    },
